...
CherenkovSteppingVerbose::CherenkovSteppingVerbose()
{}

CherenkovSteppingVerbose::~CherenkovSteppingVerbose()
{}

void CherenkovSteppingVerbose::StepInfo()
{
  CopyState();
  ...
  if (verboseLevel == 2) {
	...
	G4cout << "----------------------- End Of Secondaries Info ------------------" << G4endl;
      }
  }
  }
...
void CherenkovSteppingVerbose::TrackingStarted()
{
  CopyState();
  G4int prec = G4cout.precision(3);
  if( verboseLevel > 0) {
