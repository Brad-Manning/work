...
#	echo ${rs21}
	...
	/remote/tesla/bmanning/work/Modules/CORSIKA_thin/CORSIKA-inject-gamma/./usereadpart /remote/tesla/bmanning/data/qgsII3/proton/10E19/60deg/DAT200010.part <<EOF
   ${i}
...
mv VEM_r_bins.txt /remote/tesla/bmanning/data/SimulationData/proton/10E19/60deg/${e}PhotonVEM-inject.txt
