...
#	echo ${rs21}
	...
	/remote/tesla/bmanning/work/Modules/CORSIKA_thin/CORSIKA_thin_v2.0-genZenith/./usereadpart /remote/tesla/bmanning/data/qgsII3/proton/10E19/60deg/DAT200010.part <<EOF
   ${i}
