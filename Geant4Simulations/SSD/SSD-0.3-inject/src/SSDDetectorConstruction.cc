...
SSDDetectorConstruction::SSDDetectorConstruction()
{
  ...
  world_innerRadius = 0;
  world_outerRadius = (4*scintillatorBar_length);
  world_z = 50*cm;
...
G4VPhysicalVolume* SSDDetectorConstruction::Construct()
{
  ...
  new G4PVPlacement(0, G4ThreeVector(0,0*cm,0.5*cm),logic_vessel_cover,"vessel_cover",logicWorld,false,0,checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0,61*cm,1.5*cm), logic_vessel_horizontal_strip, "vessel_horizontal_strip_1", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0,-61*cm,1.5*cm),logic_vessel_horizontal_strip, "vessel_horizontal_strip_2", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0+186*cm,0*cm,1.5*cm), logic_vessel_vertical_strip, "vessel_vertical_strip_1",logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0-186*cm,0*cm,1.5*cm), logic_vessel_vertical_strip, "vessel_vertical_strip_2", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0,0*cm,3.0*cm), logic_vessel_bottom, "vessel_bottom", logicWorld, false, 0, checkOverlaps);

  new G4PVPlacement(0, G4ThreeVector(0,0*cm,-0.5*mm), logic_aluminum_cover, "aluminum_cover", logicWorld, false, 0, checkOverlaps);

  new G4PVPlacement(0, G4ThreeVector(0,0*cm,-10.5*mm), logic_aluminum_cover, "aluminum_cover2", logicWorld, false, 0, checkOverlaps);
  
  new G4PVPlacement(0, G4ThreeVector(0,0*cm,40.5*mm), logic_aluminum_bottom, "aluminum_bottom", logicWorld, false, 0, checkOverlaps);

  new G4PVPlacement(0, G4ThreeVector(0,0*cm, 50.5*mm), logic_aluminum_bottom, "aluminum_bottom2", logicWorld, false, 0, checkOverlaps);
  ...
  new G4PVPlacement(0, G4ThreeVector(0+105*cm,0*cm,1.5*cm), logic_scintillator_left_module, "scintillator_left_module", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, G4ThreeVector(0-105*cm, 0*cm,1.5*cm), logic_scintillator_right_module,  "scintillator_right_module", logicWorld, false, 0, checkOverlaps);
