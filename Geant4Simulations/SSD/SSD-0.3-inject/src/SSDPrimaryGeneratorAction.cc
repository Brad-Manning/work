...
void SSDPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  G4float posy = (rand() % 13000)/100.; //random number between 0 and 130;
  G4float posx = (rand() % 38000)/100.; //random number between 0 and 380;
  ...
  fParticleGun->SetParticlePosition(G4ThreeVector(-190*cm+posx*cm,-65*cm+posy*cm,6*cm));
