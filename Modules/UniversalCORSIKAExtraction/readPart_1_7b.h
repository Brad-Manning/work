...
class particle{
  fileinfo* file;
public:
  double description,p,energy,px,py,pz,x,y,z,t,weight,primtheta,primphi,zstart;//data for each particle
...
weight=file->getnextnumber();
      ...
      if (type==85 || type==86)//if a decayed muon
	{
      ...
      //////////////////////////////////////////////////////////////
      ///px,py,pz in GeV/c, p in eV/c ,x,y in cm, t is arrival time
      ///of muon at ground in ns since 1st interaction. energy is
      /// KE of muon in eV. muz is production height in cm
      ///hadgen is hadronic generation. obslev is the observation 
      ///level
      ///for muon at ground type is 75 (mu+) or 76(mu-). for 
      ///decayed muon, type is 85 or 86. in this case, there is
      ///no t. z is height at decay in cm. Decayed muons also 
      ///have a fate index mufate. 1 is decay, 2 is fatal 
      ///nuclear intercation, 3 is drop below energy threshold 
      ///or angular cut 
      ///////////////////////////////////////////////////////////
      ...
      else
	{
      ...
      //read info about non-muons here (or also muons if no prehistory)
