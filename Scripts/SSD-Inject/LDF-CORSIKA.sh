...
#	echo ${rs21}
	...
	/remote/tesla/bmanning/work/Modules/UniversalCORSIKAExtraction/./UniParticleReader <<EOF
   ${i}
EOF
	...
	/remote/tesla/bmanning/work/Geant4Simulations/SSD-build/./SSDSimulation qgs*
